...
class TempAccessDevice extends StatefulWidget {
  var ownerName;
  var dId;
  TempAccessDevice({Key? key, required this.ownerName, required this.dId})
      : super(key: key);

  @override
  _TempAccessDeviceState createState() => _TempAccessDeviceState();
}

class _TempAccessDeviceState extends State<TempAccessDevice> {
  ...
  void initState() {
    super.initState();
    switchFuture = getPinStatusData(widget.dId.toString());
    nameFuture = getPinNames(widget.dId.toString(),0);
  }
                  ...
                  SliverList(
                    ...
                    if (index < 1) {
                      return SizedBox(
                        child: Column(
                          children: [
                            deviceContainer(widget.dId, index),
                          ],
                        ),
                      );
                    } else {
